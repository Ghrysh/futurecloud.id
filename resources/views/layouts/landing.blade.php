...
<body class="antialiased bg-gray-50">
    ...
    <!-- Navbar -->
    <nav x-data="{ mobileMenuOpen: false, atTop: true, isHome: {{ request()->is('/') || request()->is('catalog') || request()->is('services') || request()->is('about-us') ? 'true' : 'false' }}, isDarkTheme: {{ request()->is('catalog') || request()->is('services') || request()->is('about-us') ? 'true' : 'false' }} }" 
    ...
    <div class="{{ request()->is('/') || request()->is('catalog') || request()->is('services') || request()->is('about-us') ? '' : 'pt-20' }}">
        @yield('content')
    </div>
