                ...
                <div class="text-center md:text-left flex-1 z-10">
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-3">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-700">
                            <i class="ri-user-star-line mr-1"></i> Anggota
                        </span>
                        
                        @if(Auth::user()->email_verified_at)
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700">
                                <i class="ri-verified-badge-line mr-1"></i> Terverifikasi
                            </span>
                        @else
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-700">
                                <i class="ri-error-warning-line mr-1"></i> Belum Terverifikasi
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        <div class="p-6 md:p-8 border-b border-gray-100 bg-gray-50/50">
                            ...
                            <p class="text-sm text-gray-500 mt-1 ml-10">Perbarui informasi profil akun Anda.</p>
                        </div>
                        ...
                        <div class="p-6 md:p-8">
                            ...
                            <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                                ...
                                <div>
                                    <label for="email">Alamat Email <span class="text-xs text-gray-400 font-normal ml-1">(Tidak dapat diubah)</span></label>
                                ...
                                <div class="flex items-center gap-4 pt-2">
                                    ...
                                    @if (session('status') === 'profile-updated')
                                        <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)" class="text-sm text-green-600 font-medium flex items-center gap-1">
                                            <i class="ri-checkbox-circle-line"></i> Tersimpan.
                                        </p>
                                    @endif
                                </div>
                            </form>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mt-8">
                        <div class="p-6 md:p-8 border-b border-gray-100 bg-gray-50/50">
                            ...
                            <p class="text-sm text-gray-500 mt-1 ml-10">Pastikan akun Anda menggunakan kata sandi yang aman.</p>
                        </div>
                        <div class="p-6 md:p-8">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">
                                            {{ Auth::user()->google_id ? 'Terhubung ke ' . Auth::user()->email : 'Belum terhubung' }}
                                        </p>
                                    </div>
                                </div>
                                @if(Auth::user()->google_id)
