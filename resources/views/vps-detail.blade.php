...
@section('content')
    ...
    <section class="w-full pt-32 pb-20 px-4 text-center bg-[#0a192f] text-white relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <span
                class="inline-block py-1 px-3 rounded-full bg-blue-900/50 border border-blue-500/30 text-blue-300 text-xs font-semibold tracking-wider mb-4 uppercase">FutureCloud
                VPS</span>
            <h1 class="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
                VPS Hosting<br><span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Kendali & Fleksibilitas
                    Penuh</span>
            </h1>
            <p class="mt-4 text-lg text-blue-100 max-w-3xl mx-auto leading-relaxed px-2 font-light">
                Saat bisnis Anda berkembang, FutureCloud memberikan performa NVMe SSD, akses root total, dan skalabilitas
                tanpa batas.
            </p>
        </div>
    </section>
